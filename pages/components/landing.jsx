...
const Landing = () => {
   return (
      <div className="h-screen mt-14">
         <div className="bg-Main mt-6 w-full h-full bg-cover bg-center grid place-items-center relative after:absolute after:block after:inset-0 after:bg-gradient-to-t after:from-rose-900 after:to-transparent">
